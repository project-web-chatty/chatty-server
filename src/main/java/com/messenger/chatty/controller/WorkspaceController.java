...
public class WorkspaceController {
    ...
    public ApiResponse<WorkspaceBriefDto> updateWorkspaceProfile
    ...
    public ApiResponse<Boolean> changeRoleOfMember( @PathVariable Long workspaceId, @PathVariable Long memberId,
